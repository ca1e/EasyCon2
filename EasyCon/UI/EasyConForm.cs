...
namespace EasyCon.UI
{
    public partial class EasyConForm : Form, IOutputAdapter
    {
        ...
        internal CaptureVideoFrm captureVideo;
        internal TutorialForm tutorialFrm;
        ...
        private Script.Script _program;
        private bool scriptCompiling = false;
        private Thread scriptThread;

        private DateTime _startTime = DateTime.MinValue;
        private TimeSpan _lastRunningTime = TimeSpan.Zero;
        private Queue<Tuple<RichTextBox, object, Color?>> _messages = new Queue<Tuple<RichTextBox, object, Color?>>();
        ...
        private void UpdateUI()
        {
            try
            {
                while (true)
                {
                    Invoke((Action)delegate
                    {
                        ...
                        labelTimer.ForeColor = scriptThread == null ? Color.White : Color.Lime;
            ...
            {
                MessageBox.Show("UI Task error occured!");
            }
        }
        ...
        private bool ScriptCompile()
        {
            ...
            try
            {
                ...
                foreach (var il in CaptureVideoFrm.imgLabels)
                {
        ...
        private void ScriptRun()
        {
            ...
            if (!CheckFirmwareVersion())
                return;
            scriptThread = new Thread(_RunScript);
        ...
        private void buttonShowController_Click(object sender, EventArgs e)
        {
            ...
            {
                formController.ShowControllerHelp();
        ...
        private void CaptureDeviceItem_Click(object sender, EventArgs e)
        {
            ...
            captureVideo = new CaptureVideoFrm((int)(((ToolStripMenuItem)sender).Tag), dev_type);
            captureVideo.Show();
        }
...
#region  EasyCon菜单功能
        ...
        private void 脚本教程MenuItem_Click(object sender, EventArgs e)
        {
            tutorialFrm = new TutorialForm();
            tutorialFrm.Show();
        }
